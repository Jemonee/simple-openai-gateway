...
const (
	...
	OpenAIPriceCatalogTier      = "standard_1m_context"
	OpenAIPriceCatalogVersion   = "2026-08"
	OpenAIPriceCatalogUpdatedAt = "2026-08"
)
...
var openAITokenPrices = map[string]officialPriceEntry{
	"gpt-5.6-sol":            {input: 5_000_000, output: 30_000_000, cachedInput: priceMicros(500_000)},
	"gpt-5.6-terra":          {input: 2_000_000, output: 12_000_000, cachedInput: priceMicros(250_000)},
	"gpt-5.6-luna":           {input: 200_000, output: 1_200_000, cachedInput: priceMicros(100_000)},
	...
	"reasoning":              {input: 1_000_000, output: 6_000_000},
	...
	"text-embedding-3-large": {input: 130_000},
	"text-embedding-3-small": {input: 20_000},
	"omni-moderation-latest": {},
	"gpt-5.6-sol-realtime":   {input: 10_000_000, output: 45_000_000, cachedInput: priceMicros(1_000_000)},
	"gpt-5.6-terra-realtime": {input: 4_000_000, output: 18_000_000, cachedInput: priceMicros(500_000)},
	"gpt-5.6-luna-realtime":  {input: 400_000, output: 1_800_000, cachedInput: priceMicros(200_000)},
}
...
func OpenAIOfficialPrice(modelID string) *OfficialModelPrice {
	entry, ok := openAITokenPrices[modelID]
	if !ok {
		return nil
	}
