...
.manual-toc { min-height: 0; overflow: auto; border-left: 2px solid var(--hongfen-border-strong); padding-left: 14px; scrollbar-gutter: stable; }
.manual-toc > strong { color: var(--hongfen-text); font-size: 12px; font-weight: 650; }
.manual-toc nav { display: grid; gap: 2px; margin-top: 10px; }
.manual-toc a { padding: 5px 7px; border-radius: var(--hongfen-radius-control); color: var(--hongfen-text-muted); font-size: 11px; line-height: 1.35; }
.manual-toc a:hover, .manual-toc a:focus-visible { color: var(--hongfen-primary); background: var(--hongfen-primary-soft); }
.manual-reading { display: grid; min-width: 0; min-height: 0; grid-template-rows: auto minmax(0, 1fr); overflow: hidden; border: 1px solid var(--hongfen-border); background: var(--hongfen-surface); }
.manual-header { padding: 26px 42px 22px; border-bottom: 1px solid var(--hongfen-border); background: var(--hongfen-surface); }
...
.manual-markdown { color: var(--hongfen-text-muted); font-size: 13px; line-height: 1.8; }
.manual-markdown :deep(h1) { margin: 0 0 8px; color: var(--hongfen-text); font-size: 26px; font-weight: 650; line-height: 1.3; }
.manual-markdown :deep(h2) { margin: 26px 0 12px; padding-top: 14px; border-top: 1px solid var(--hongfen-border); color: var(--hongfen-text); font-size: 18px; font-weight: 650; line-height: 1.4; scroll-margin-top: 14px; }
.manual-markdown :deep(h3) { margin: 24px 0 8px; color: var(--hongfen-text); font-size: 14px; font-weight: 650; scroll-margin-top: 14px; }
.manual-markdown :deep(p) { margin: 10px 0; }
.manual-markdown :deep(blockquote) { margin: 16px 0 14px; padding: 10px 14px; border-left: 3px solid var(--hongfen-primary); color: var(--hongfen-text-muted); background: var(--hongfen-surface-muted); }
...
.manual-markdown :deep(code) { padding: 2px 4px; border: 1px solid var(--hongfen-border); border-radius: 2px; color: var(--hongfen-text); background: var(--hongfen-surface-muted); }
.manual-markdown :deep(strong) { color: var(--hongfen-text); font-weight: 650; }
.manual-markdown :deep(a) { color: var(--hongfen-primary); text-decoration: underline; text-underline-offset: 2px; }
@media (max-width: 960px) {
  ...
  .manual-toc a { flex: none; border: 1px solid var(--hongfen-border); background: var(--hongfen-surface); }
}
